...
dependencies {
    ...
    // DDC
    api("com.github.Cerebellum-Network.cere-ddc-sdk-kotlin:core:1.0.2.Final")
    api("com.github.Cerebellum-Network.cere-ddc-sdk-kotlin:proto:1.0.2.Final")
    api("com.github.Cerebellum-Network.cere-ddc-sdk-kotlin:content-addressable-storage:1.0.2.Final")
    api("com.github.Cerebellum-Network.cere-ddc-sdk-kotlin:key-value-storage:1.0.2.Final")
